...
if($_SESSION["core_session_sys_id"]==""){
  if(strstr($_SERVER['REQUEST_URI'],"Adminmanage/login.php")!="Adminmanage/login.php"){
	echo "<meta charset='UTF-8'><meta http-equiv='refresh' content='0;url=../Adminmanage/login.php'/>";
  }
}
