...
function editUser(id,admin) {
	...
	var editUsername = $('#editUsername'+id).val();
	var editPassword = $('#editPassword'+id).val();
	var editfname = $('#editfname'+id).val();
	var editlname = $('#editlname'+id).val();
	var editNname = $('#editNname'+id).val();
	var editPhone = $('#editPhone'+id).val();
	var editEmail = $('#editEmail'+id).val();
	var editLine = $('#editLine'+id).val();
	var myaction = 'editUser';



	if(admin == 1){
		var editMwallet = $('#editMwallet'+id).val();
		var editBwallet = $('#editBwallet'+id).val();
		var editBank = $('#editBank'+id).val();
	}else{
		var editMwallet = '';
		var editBwallet = '';
		var editBank = '';
	...
	var dataSet={
		...
		editEmail : editEmail,
		editLine : editLine,
		editMwallet : editMwallet,
		editBwallet : editBwallet,
		editBank : editBank,
		myaction : myaction,
		ck : admin
	};
